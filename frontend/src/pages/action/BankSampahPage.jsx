...
const BankSampahPage = () => {
  ...
  // ======================================================
  // FETCH MITRA
  // Kalau ada hasil scan → filter by waste label
  // Kalau tidak ada → tampilkan semua mitra aktif
  // ======================================================
  ...
  // ======================================================
  // LOG AKSI KE MITRA YANG DIPILIH
  // ======================================================
  ...
  return (
    <section className="min-h-screen bg-slate-50 py-12 px-6">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        {/* LOG FORM — muncul hanya kalau ada mitra dipilih */}
        {selectedMitra && (
          <div className="bg-white rounded-2xl shadow-sm border p-6 space-y-4">
            ...
            <p className="text-sm text-slate-500">
              Catat aksimu dan dapatkan +20 poin!
            </p>
            ...
            >
              {logLoading ? "Menyimpan..." : "✓ Catat Setor Sampah (+20 poin)"}
            </button>
          </div>
        )}
...
const SuccessBanner = ({ mitraName, onHome, onHistory }) => (
  <section className="min-h-screen bg-slate-50 flex items-center justify-center px-6">
    <div className="max-w-sm w-full bg-white rounded-2xl shadow-sm border p-8 text-center space-y-4">
      ...
      <p className="text-slate-500 text-sm">
        ...
        berhasil dicatat. Kamu mendapat{" "}
        <span className="font-bold text-green-600">+20 poin</span>.
      </p>
